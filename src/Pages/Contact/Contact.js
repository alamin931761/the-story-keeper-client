        ...
        <div className='common-style' data-aos="fade-down" data-aos-duration="1000">
            ...
            <div className='grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 mt-8'>
                ...
                <div className='w-full'>
                    ...
                    <form ref={form} className='flex flex-col justify-center mx-3' onSubmit={handleSubmit(onSubmit)}>
                        {/* Name */}
                        ...
                        <div className='w-full mb-5'>
                            ...
                            <textarea name='message' className="textarea textarea-bordered w-full text-base" cols="30" rows="5" {...register("message", {
                                required: {
                                    value: true,
                                    message: "Message field is required"
                                }
                            })} />
                            <label className="label pb-0 pt-0">
                                {errors.message?.type === 'required' && <span className="label-text-alt text-red-400">{errors.message.message}</span>}
                            </label>
                        </div>
                        <button type='submit' className='btn btn-outline w-[180px] transition ease-linear duration-500'>Send Message <SlPaperPlane className='text-xl ml-2' /></button>
                    </form>
                </div>
            </div>
