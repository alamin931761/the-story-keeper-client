...
const Services = () => {
    return (
        <div className='mt-10 flex justify-around flex-wrap bg-[#DFF6FF] rounded-lg' data-aos="fade-up" data-aos-duration="1000">
            {/* quick delivery */}
            <div className='flex flex-col items-center my-5' data-aos="flip-left" data-aos-duration="3000">
