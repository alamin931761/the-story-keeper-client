...
const BookDetails = () => {
    ...
    if (reviews) {
        ...
        reviewContainer = <div className='mt-6 flex flex-col items-center justify-center'>
    ...
    return (
        <div className='common-style mb-6' data-aos="fade-right" data-aos-duration="1000">
            ...
            <div className='flex justify-center'>
                <div className='flex flex-wrap lg:flex-nowrap shadow-2xl bg-[#DFF6FF] justify-center'>
                    ...
                    <div className='ml-5 pt-5 mr-5 lg:w-[550px]'>
                        ...
                        <h1 className='text-xl mt-4'>{subtitle}</h1>
            ...
            <div className='mt-12 mb-6'>
                <h2 className='text-center text-3xl'>Reviews({totalReview})</h2>
                <div className='flex items-center justify-between'>
                    <p>Get specific details about this book from customers who own it.</p>
                    <button onClick={handleAddReview} className='btn btn-outline'>Write a Review</button>
                </div>
                <p><span className='font-semibold'>Ratings:</span> {averageRating} out of 5</p>
