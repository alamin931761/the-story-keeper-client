...
const DeliveryDetails = () => {
    ...
    return (
        <div className='common-style' data-aos="fade-up" data-aos-duration="1000">
            ...
            <h2 className='text-center text-3xl my-6 second-font'>Delivery Details</h2>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col justify-center items-center'>
                ...
                {
                    <input className='btn btn-outline mt-0 mb-6 transition ease-linear duration-500' type="submit" value="Submit details" />
                }
            </form>

            <div className='flex justify-center mb-6'>
                <Link disabled={checkoutButton} className='btn btn-outline transition ease-linear duration-500' to='/checkout'>Proceed to checkout<BsBagCheck className='ml-2 text-2xl mb-1' /></Link>
            </div>
        </div>
    );
};
