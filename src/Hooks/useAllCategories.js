...
const useAllCategories = () => {
    ...
    const { setCount, page, size, sorted, minimumSliderValue, maximumSliderValue, category } = useContext(PAGINATION_AND_FILTER_CONTEXT);
    ...
    }, [page, size, sorted, minimumSliderValue, maximumSliderValue, setCount, category, setBooks, books])
